...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 13 sep. 2022 à 21:36
...
CREATE TABLE IF NOT EXISTS `attaque` (
  ...
  `stat_pp` int NOT NULL,
  `stat_puissance` int DEFAULT NULL,
  `stat_precision` int NOT NULL,
  PRIMARY KEY (`id_attaque`),
  UNIQUE KEY `id_attaque` (`id_attaque`),
  KEY `type_id` (`type_id`)
...
(10, 7, 0, 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/010.png', 'Pour se protéger, il émet par ses antennes une odeur nauséabonde qui fait fuir ses ennemis.'),
...
(13, 7, 10, 'https://assets.pokemon.com/assets/cms2/img/pokedex/full/013.png', 'L\'aiguillon sur son front est très pointu. Il se cache dans les bois et les hautes herbes, où il se gave de feuilles.'),
...
CREATE TABLE IF NOT EXISTS `pokemon` (
  `id_pok` int UNSIGNED NOT NULL AUTO_INCREMENT,
...
(26, 1, 'Bienvenue !', 'J\'aime la bite', '2022-09-07');
...
(1, 'Badge Roche', 'https://static.wikia.nocookie.net/pokemon/images/2/24/Boulderbadge.png', 'CT Patience', 'Total Soin', 'https://www.pokepedia.fr/images/a/a5/Patience_RBJ_animation.gif', 'https://www.media.pokekalos.fr/img/pokemon/objets/big/total-soin.png'),
(2, 'Badge Cascade', 'https://static.wikia.nocookie.net/pokemon/images/4/4d/Cascadebadge.png', 'CT Bulles d\'O', 'Défense +', 'https://www.pokepedia.fr/images/1/1c/Bulles_d%27O_RBJ_animation.gif', 'https://www.media.pokekalos.fr/img/pokemon/objets/big/defense-plus.png'),
(3, 'Badge Foudre', 'https://static.wikia.nocookie.net/pokemon/images/a/a8/Thunderbadge.png', 'CT Tonnerre', 'Vitesse +', 'https://www.pokepedia.fr/images/3/3c/Tonnerre_RBJ_animation.gif', 'https://www.media.pokekalos.fr/img/pokemon/objets/big/vitesse-plus.png'),
(4, 'Badge Prisme', 'https://static.wikia.nocookie.net/pokemon/images/b/b5/Rainbow_Badge.png', 'CT Méga-Sangsue', 'Super Potion', 'https://www.pokepedia.fr/images/5/52/Méga-Sangsue_RBJ_animation.gif', 'https://www.media.pokekalos.fr/img/pokemon/objets/big/super-potion.png'),
(5, 'Badge Âme', 'https://static.wikia.nocookie.net/pokemon/images/6/64/Soulbadge.png', 'CT Toxik', 'Attaque +', 'https://www.pokepedia.fr/images/a/a9/Toxik_RBJ_animation.gif', 'https://www.media.pokekalos.fr/img/pokemon/objets/big/attaque-plus.png'),
(6, 'Badge Marais', 'https://static.wikia.nocookie.net/pokemon/images/1/1c/Marshbadge.png', 'CT Vague Psy', 'Hyper Potion', 'https://www.pokepedia.fr/images/d/df/Vague_Psy_RBJ_animation.gif', 'https://www.media.pokekalos.fr/img/pokemon/objets/big/hyper-potion.png'),
(7, 'Badge Volcan', 'https://static.wikia.nocookie.net/pokemon/images/d/d9/Volcanobadge.png', 'CT Déflagration', 'Super Potion', 'https://www.pokepedia.fr/images/1/12/Déflagration_RBJ_animation.gif', 'https://www.media.pokekalos.fr/img/pokemon/objets/big/super-potion.png'),
(8, 'Badge Terre', 'https://static.wikia.nocookie.net/pokemon/images/c/cc/Earthbadge.png', 'CT Abîme', 'Défense Spéc', 'https://www.pokepedia.fr/images/d/d9/Abîme_RBJ_animation.gif', 'https://www.media.pokekalos.fr/img/pokemon/objets/big/defense-plus.png');
...
DROP TABLE IF EXISTS `statcombat`;
CREATE TABLE IF NOT EXISTS `statcombat` (
  `id_pok` int NOT NULL,
  `stat_pv` int NOT NULL,
  `stat_force` int NOT NULL,
  `stat_defense` int NOT NULL,
  `stat_vitesse` int NOT NULL,
  `stat_special` int NOT NULL,
  KEY `id_pok` (`id_pok`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
DROP TABLE IF EXISTS `stockepokemon`;
CREATE TABLE IF NOT EXISTS `stockepokemon` (
  `id_dress` int NOT NULL,
  `id_pok` int NOT NULL,
  `lvl_pok` int NOT NULL,
...
(50, 'JohnKie', 'johnkie@mail.com', '$2y$10$iWulvcbRu/r/DifBB02wj.6tUqaAdN0pF7Dynu3/hV1d74Rr7.dq2', '2022-09-07 15:19:03', '2022-09-07 15:19:03');
...
(50, 'John', 'Kie', '0669696969', '2022-09-07 15:19:03', '2022-09-07 15:19:03');
